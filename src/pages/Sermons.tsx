...
import { fetchAllSermons, fetchSermonsApi } from '@/services/apiSermons'
...
const Sermons = () => {
  ...
  const filteredSermons = useMemo(() => {
    ...
    // Apply other filters
    if (selectedSpeaker)
      results = results.filter((s) => s.speaker === selectedSpeaker)
    if (selectedTopic)
      results = results.filter((s) => s.topic === selectedTopic)
    if (selectedDate) results = results.filter((s) => s.date === selectedDate)
    if (activeTab !== 'all')
      results = results.filter((s) => s.type === activeTab)
      ...
      <div className="pt-24 pb-12 relative">
        ...
        <div className="container-custom text-center relative z-10">
          ...
          <p className="text-white/90 max-w-2xl mx-auto text-lg">
            Listen to spirit-filled messages that will inspire and transform
            your life
          </p>
        </div>
      </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-xl max-w-4xl mx-auto">
              <div className="relative">
                ...
                <a
                  ...
                  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-divine/80 hover:bg-divine text-white rounded-full p-6 transition-colors"
                >
                  <Play
                    size={32}
                    className="ml-1"
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Discover how to align your life with God's purpose and fulfill
                  your divine destiny in this powerful message.
                </p>
                <div className="flex items-center justify-between">
                  <div>
