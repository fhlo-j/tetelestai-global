    ...
    <div className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <video autoPlay muted loop className="w-full h-full object-cover">
          <source
            src="https://res.cloudinary.com/dhgtx9k3d/video/upload/v1745537986/IMG_0862_wwkoyi.mp4"
            type="video/mp4"
          />
      ...
      <div className="container-custom relative z-20 pt-20 pb-20 md:pt-24 md:pb-24">
        <div
          className={`max-w-3xl ${loaded ? "animate-fade-in" : "opacity-0"}`}
        >
          <motion.h1
            key={textIndex}
          ...
          >
            Embrace the divine journey of faith, hope, and love as we connect
            hearts to God's eternal purpose. It is finished!
          </motion.p>
