...
export const leaders: Leader[] = [
  {
    ...
    image:
      "https://res.cloudinary.com/dhgtx9k3d/image/upload/v1745538527/WhatsApp_Image_2025-04-21_at_02.12.15_48314a8b_uuwgxj.jpg",
    socialMedia: {
    ...
    familyInfo:
      "Pastor Emmanuel is happily married to Sarah Johnson for 25 years. They have three children who are also active in ministry.",
    visionStatement:
      "To see a church without walls, reaching the unreached and discipling nations with the profound truth of Christ's finished work.",
  },
  {
    id: "sarah-williams",
    name: "Sarah Williams",
  ...
  },
  {
    ...
    familyInfo:
      "David and his wife Rachel have been married for 12 years. They have four children and are also foster parents.",
  },
  {
    id: "rebecca-jackson",
  ...
  },
  {
    ...
    familyInfo:
      "Michael is married to Jennifer, and they have two teenage daughters who are active in the youth ministry.",
  },
];
